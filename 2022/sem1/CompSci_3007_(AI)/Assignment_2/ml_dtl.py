...
if __name__ == "__main__":
    ...
    clf = DecisionTree(min_samples_split=minleaf)
    clf.fit(training_dataset[1:,:-1], training_dataset[1:,-1])

    y_pred = clf.predict(testing_dataset[1:,:])
    acc = accuracy(testing_dataset_result, y_pred)
